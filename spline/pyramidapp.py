...
def main(global_config, **settings):
    pylons_settings = settings.copy()
    pylons_settings.update(full_stack=False)
    pylonsapp = make_app(global_config, **pylons_settings)

    import spline.lib.makoext
    settings['mako.preprocessor'] = spline.lib.makoext.i18n_preprocessor
